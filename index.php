...
<html>
    ...
    <div class="page-wrap">
      ...
      <div class="md-content">
        ...
        <div class="slider">
          ...
          <div
            class="carousel__element owl-carousel"
            data-options='{"items":1,"loop":false,"dots":false,"nav":false,"margin":0, "autoplay": true, "autoplayTimeout": 3000}'
          >
            <div
              class="slider__item"
              style="
                background-image: url('assets/img/slider.jpeg');
              ...
              <div class="md-tb">
                <div class="md-tb__cell">
                  <div class="slider__content">
                    <div class="container">
                      <h2>Technology and Development Solutions Cell</h2>
                      <p>
                        CTARA | IIT Bombay
                      </p>
                    </div>
                ...
                <div class="md-tb__cell">
                  <div class="slider__content">
                    <div class="container">
                      ...
                      <p>
                        Curabitur elementum urna augue, eu porta purus gravida
                        in. Cras consectetur, lorem a cursus vestibulum, ligula
                        purus iaculis nulla, in dignissim risus turpis id justo.
                        Sed eleifend ante et ligula elei
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section
          ...
          style="background-color: #f7f7f7; margin: 40px;"
        >
          <div class="container">
              ...
              <div class="row">
                  ...
                  <div class="textbox">
                    ...
                    <div class="textbox__body">
                      <h2 class="textbox__title">
                        <a href="#"
                          >Need-assessment and pre-feasibility analysis</a
                        >
                      </h2>
                      <div class="textbox__description">
                        Quantitative study of a basic needs problem at a
                        specific location, and an exploration of possible
                        solutions
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-4 col-lg-4">
                  ...
                  <div class="textbox">
                    ...
                    <div class="textbox__body">
                      <h2 class="textbox__title">
                        <a href="#">Third-party audit and evaluation</a>
                      </h2>
                      <div class="textbox__description">
                        Neutral third-party evaluation of an existing or planned
                        scheme/programme/project (technical design, economic
                        feasibility)
                      </div>
                    </div>
                  </div>
  ...
  <h6 class="title-01__subTitle">news</h6>
	...
	<div class="panel-footer">
                ...
                <div class="iconbox">
                  ...
                  <div>
                    <h2 class="iconbox__title">
                      <a href="#">Best National Locations</a>
                    </h2>
                    <div class="iconbox__description">
                      Nam elit ligula, egestas et ornare non, viverra eu justo.
                      Aliquam ornare lectus ut pharetra dictum. Aliquam erat
                      volutpat. In fringilla erat at eros pharetra faucibus.
                      Nunc a magna eu lectus fringilla interdum luctus vitae
                      diam. Morbi ac orci ac dolor pellentesque interdum vel
                      accumsan risus. In ves
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-md-6 col-lg-3">
                <div class="iconbox iconbox__style-02">
                  ...
                  <div>
                    ...
                    <div class="iconbox__description">
                      Mauris lacinia venenatis dolor sit amet viverra. Integer
                      malesuada nulla neque. Sed rutrum ligula eu
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-6 col-lg-3">
                <div class="iconbox iconbox__style-02">
                  ...
                  <div>
                    ...
                    <div class="iconbox__description">
                      Etiam non varius justo, vel tempor mi. Nulla facilisi.
                      Fusce at tortor arcu. Suspendisse maximus ac
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-md-6 col-lg-3">
                <div class="iconbox iconbox__style-02">
                  ...
                  <div>
                    ...
                    <div class="iconbox__description">
                      Suspendisse ac elit vitae est lacinia interdum eu sit amet
                      mauris. Phasellus aliquam nisi sit amet l
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="title-01 title-01__style-03 md-text-left">
                  ...
                  <div>
                    Technology and Development Solutions Cell is a resource
                    center for providing technology-based solutions for the
                    development sector. TDSC provides resources and services to
                    undertake projects that deliver outputs via academic
                    research outputs, consulting, outreach modules,
                    entrepreneurship guidance, etc. TDSC not only aims at
                    delivering solutions to external stakeholders but primarily
                    uses the academic platform to engage students directly in
                    development-related problems and solutions. The resources of
                    the center can be leveraged by faculty and students of IIT
                    Bombay and other colleges to provide solutions to the
                    community and various development stakeholders.
                    Mini-governing note for TDSC as written at the inception of
                ...
                <div class="row">
                  <div class="col-sm-4">
                    ...
                    <div class="box-number">
                      ...
                      <div class="box-number__description">Clients</div>
                    </div>
                    <!-- End / box-number -->
                  </div>
                  <div class="col-sm-4">
                    ...
                    <div class="box-number">
                      ...
                      <div class="box-number__description">Projects</div>
                    </div>
                    <!-- End / box-number -->
                  </div>
                  <div class="col-sm-4">
        ...
        <!-- Section -->
        <!-- <section
          class="md-section md-skin-dark js-consult-form"
        ...
        <!-- Section -->
        <!-- <section id="tdsc-news" class="md-section" style="padding-bottom: 0;">
          <div class="container">
            <div class="row">
              <div
              ...
              >
                <div class="title-01" style="margin-bottom: 50px;">
                  <h2 class="title-01__title">NEWS</h2>
                </div>
              </div>
            </div>
            <div class="consult-slide">
              <div
                class="carousel__element owl-carousel"
                data-options='{"loop":true,"autoplay":true,"autoplayTimeout":1500,"autoplayHoverPause":false,"items":3,"dots":false,"nav":false,"margin":30,"responsive":{"0":{"items":1},"992":{"items":2}}}'
              >
                <div class="testimonial">
                  <div class="">
                    <span class="testimonial__position">12/12/12</span>
                  </div>
                  <div class="testimonial__content">
                    <div class="testimonial__text">
                      Taluka level training for water budget calculation and
                      village plan preparation for Jalyukta Shivar Abhiyan (year
                      2018-19) in Palghar district
                    </div>
                  </div>
                </div>
                ...
                <div class="testimonial">
                  ...
                  <div class="testimonial__content">
                    <div class="testimonial__text">
                      4 days course delivered to students of PGD(WASH) at TISS
                      Tuljapur.
                    </div>
                  </div>
                </div>
                ...
                <div class="testimonial">
                  ...
                  <div class="testimonial__content">
                    <div class="testimonial__text">
                      TDSC to collaborate with Zilla Parishad Palghar towards
                      the revival of Pathardi water supply scheme
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              <div>
                <div class="post-01__media">
                  <a href="#"
                    ><img src="assets/img/blogs/related-1.jpg" alt=""
                  /></a>
                </div>
                <div>
              ...
              <div>
                <div class="post-01__media">
                  <a href="#"
                    ><img src="assets/img/blogs/related-2.jpg" alt=""
                  /></a>
                </div>
                <div>
                  <ul class="post-01__categories">
              ...
              <div>
                <div class="post-01__media">
                  <a href="#"
                    ><img src="assets/img/blogs/related-3.jpg" alt=""
                  /></a>
                </div>
                <div>
                  <ul class="post-01__categories">
              ...
              <div>
                <div class="post-01__media">
                  <a href="#"
                    ><img src="assets/img/blogs/related-4.jpg" alt=""
                  /></a>
                </div>
                <div>
                  <ul class="post-01__categories">
      ...
      <footer class="footer">
          ...
          <div class="row row-eq-height">
            <div class="col-8 col-sm-7 col-md-9 col-lg-3">
              <div class="footer__item">
                <a class="consult_logo" href="#"
                  ><img src="assets/img/logo.png" width="200px" alt=""
                /></a>
                <p>
                  2nd Floor, Old CSE Building, IIT Bombay, Powai, Mumbai,
                  Maharashtra 400076
                </p>
              </div>
            </div>
            ...
            <!-- <div class="col-md-4 col-lg-2 col-xl-2">
              <div class="footer__item">
                <div class="form-sub">
                  <h4 class="form-sub__title">Social Media</h4>
                  <div class="widget-text__content">
                    <ul>
        ...
        <div class="footer__copyright">
          2020 &copy; Copyright TDSC. All rights Reserved.
        </div>
      </footer>
    ...
    <script
      type="text/javascript"
      src="assets/vendors/jquery.countdown/jquery.countdown.min.js"
    ></script>
    <script
      type="text/javascript"
      src="assets/vendors/jquery.countTo/jquery.countTo.min.js"
    ></script>
    <script
      type="text/javascript"
      src="assets/vendors/jquery.countUp/jquery.countup.min.js"
    ></script>
    <script
      type="text/javascript"
    ...
    <script
      type="text/javascript"
      src="assets/vendors/jquery.mb.ytplayer/jquery.mb.YTPlayer.min.js"
    ></script>
    <script
      type="text/javascript"
    ...
    <script
      type="text/javascript"
      src="assets/vendors/menu/menu.min.js"
    ></script>
    <script
      type="text/javascript"
      src="assets/vendors/smoothscroll/SmoothScroll.min.js"
    ></script>
    <!-- App-->
